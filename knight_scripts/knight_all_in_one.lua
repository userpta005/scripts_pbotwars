...
macro(CHECK_MS, "Auto Ring Crowd", "Shift+8", function()
  ...
  -- Recupera o estado apos reload: se ja estiver usando o ring alvo, marca como gerenciado.
  ...
  -- Se fomos nos que equipamos, remove mesmo que o ID do item mude ao equipar.
